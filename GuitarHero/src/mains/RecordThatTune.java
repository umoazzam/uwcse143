package mains;// This program can be used to record a song played using a guitars.classes.Guitar37 object.
...
import classes.Guitar37;
import classes.StdAudio;
import classes.StdDraw;
...
public class RecordThatTune {
    ...
    public static void giveIntro() {
        ...
        System.out.println("on a guitars.classes.Guitar object and store it in an output");
