package classes;// string.txt which has a series of test cases with the correct answers.
...
public class TestString {
    ...
    public static void testWithArray(Scanner input) {
        ...
        for (int i = 0; i < cases; i++) {
            ...
            System.out.println("Testing guitars.classes.GuitarString with this array:");
    ...
    public static void testWithFrequency(Scanner input) {
        ...
        for (int i = 0; i < cases; i++) {
            ...
            int size = input.nextInt();
            System.out.println("Testing guitars.classes.GuitarString with frequency " + freq);
