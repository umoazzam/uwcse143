package classes;// This is a program that can be used to test the basic functionality of the
// guitars.classes.Guitar37 class.  It does not test all of the functionality.
//
// The main method has an array of 37 frequency values that should be produced
// by a correctly working guitars.classes.Guitar37 class.  The actual frequencies don't all end
// in 0.25, but this version of guitars.classes.GuitarString converts them to that form so that
...
public class Test37 {
    ...
    public static void main(String[] args) {
        ...
        // compare(frequencies, classes.GuitarString.nums);
    ...
    public static void compare(double[] nums, Set<Integer> nums1) {
        ...
        if (!nums1.equals(nums2)) {
            System.out.println("Wrong frequencies for guitars.classes.Guitar37 construction.");
